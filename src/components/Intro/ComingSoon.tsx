    ...
    <section className="w-full h-screen relative overflow-y-hidden">
      ...
      {isMobileFirst && (
        <motion.div
          ...
          className="bg-black text-white h-1/2 flex flex-col justify-center items-center"
        >
          <div className=" w-80">
            <motion.img
              animate={{
      ...
      <motion.div
        ...
        transition={{ duration: 0.8 }}
        className="absolute bg-white p-12 bottom-0 right-0 lg:max-w-2xl flex flex-col gap-6 h-1/2 lg:h-auto"
      >
